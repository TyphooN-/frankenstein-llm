#!/usr/bin/env python3
"""Wait for phases one through three, then run candidate downloads."""
...
PHASES = (
    ...
    (ROOT / "download-state-phase3.json", ROOT / "downloads-phase3-complete.ok", "30987169046"),
)
...
environment.update({
    "HERMES_DOWNLOAD_QUEUE": str(ROOT / "download-queue-phase4.json"),
    "HERMES_DOWNLOAD_STATE": str(ROOT / "download-state-phase4.json"),
    "HERMES_DOWNLOAD_LOCK": str(ROOT / "download-queue-phase4.lock"),
    "HERMES_DOWNLOAD_STAMP": str(ROOT / "downloads-phase4-complete.ok"),
    "HERMES_DOWNLOAD_LOG": str(ROOT / "downloads-phase4.log"),
})
