...
Durable decisions are separate from dated research snapshots. Living usage and
implementation references start at the [documentation index](../README.md).

- [0001 — Git-tracked workspace without weights](0001-git-tracked-workspace-without-weights.md)
- [0002 — Serialized functional qualification](0002-serialized-functional-qualification.md)
...
context and should not be treated as a live host inventory.
