...
1. `gemma4-heretic-vision` (Gemma-4-12B-it-heretic-Q6_K.gguf, 9.10 GiB, gemma4 ?B Q6_K, split `1/0/0`) — 40.34 tok/s
2. `qwen3-coder-next` (Qwen3-Coder-Next-Q4_K_M-00001-of-00004.gguf, 45.08 GiB, qwen3next 80B.A3B Q4_K - Medium, split `5/8/4`) — 36.33 tok/s
3. `gemma4-heretic` (Gemma-4-12B-it-heretic-Q6_K.gguf, 9.10 GiB, gemma4 ?B Q6_K, split `1/0/1`) — 24.13 tok/s
4. `phr00ty` (Phr00tyMix-v4-32B-imat-Q6_K.gguf, 25.03 GiB, qwen2 32B Q6_K, split `1/1/1`) — 12.52 tok/s
