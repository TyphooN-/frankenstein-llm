...
- llama.cpp: tracked submodule `upstream/llama.cpp`, pinned to `master` commit `9f31776c` (b10988), with the HIP/ROCm binary at `upstream/llama.cpp/build/bin/llama-server` (see [ADR 0005](decisions/0005-track-llama-cpp-submodule.md)).
