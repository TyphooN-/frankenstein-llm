...
| GLM-5.3-Flash | **upstream support** | The pinned runtime (`9f31776c`) has no `glm5next` architecture. Requires a reviewed experimental worktree below the submodule, and a clean idle-host 32K retry. No production alias is permitted first. |
